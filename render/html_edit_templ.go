...
func Select(props *Props, lookup Lookup) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case ModeEdit, ModeCreate:
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" uk-cloak cls-custom=\"button: uk-input-fake justify-between w-full; dropdown: w-full\" icon=\"chevron-down\"><select hidden>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if !isRequired(props.Field) {
				if currentKey(lookup) == "" {
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<option value=\"\" selected>None</option> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
			...
			for key, label := range lookup.Choices() {
				if currentKey(lookup) == key {
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<option data-keywords=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</select></uk-select>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case ModeView:
			if lookup.current.Len() == 0 {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<span class=\"text-gray-500 italic\">None selected</span>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
		...
		case ModeEdit, ModeCreate:
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" cls-custom=\"button: uk-input-fake justify-between w-full; dropdown: w-full\" icon=\"chevron-down\" multiple><select hidden multiple>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for key, label := range lookup.Choices() {
...
func Strings(props *Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case ModeEdit, ModeCreate:
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"uk-form-sm\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func Range(props *Props, min, max, step float64) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case ModeEdit, ModeCreate:
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<uk-input-range name=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" label=\"\" label-position=\"top\" class=\"w-full\"></uk-input-range>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
func StructTabs(props *Props, tabs map[string][]templ.Component, tabOrder []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"uk-margin\"><ul class=\"uk-subnav uk-subnav-primary pb-5\" data-uk-switcher>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, tabName := range tabOrder {
			...
			templ_7745c5c3_Var54, templ_7745c5c3_Err = templ.JoinStringErrs(tabName)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `render/html_edit.templ`, Line: 195, Col: 29}
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</ul><ul class=\"uk-switcher uk-margin\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, tabName := range tabOrder {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<li><div class=\"grid gap-2\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func StructPtr(props *Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case ModeEdit, ModeCreate:
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"uk-btn uk-btn-ghost text-xs\" uk-tooltip=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func Slice(props *Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		switch props.Mode {
		case ModeEdit, ModeCreate:
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<button type=\"button\" class=\"uk-btn uk-btn-ghost text-xs\" uk-tooltip=\"title: Add new item; pos: top\" hx-get=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var65 string
			templ_7745c5c3_Var65, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/make/%s?ns=%s&path=%s", props.Kind, props.Context.Namespace, props.Name))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var66, templ_7745c5c3_Err = templ.JoinStringErrs("#" + props.ID("list"))
			if templ_7745c5c3_Err != nil {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span> <button type=\"button\" class=\"uk-btn uk-btn-ghost text-xs\" uk-tooltip=\"title: Collapse/Expand; pos: top\" uk-toggle=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var74, templ_7745c5c3_Err = templ.JoinStringErrs(props.ID("list"))
		if templ_7745c5c3_Err != nil {
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case ModeView:
			for i := 0; i < len(lookup.objects); i++ {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<span class=\"uk-tag uk-tag-primary m-px\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
