...
type Namespace struct {
	...
	Name  string `json:"name" form:"rw" validate:"required,lowercase,alphanum,min=2,max=25"`
	Label string `json:"label" form:"rw" validate:"required,min=2,max=50"`
	Desc  string `json:"desc" form:"rw" validate:"max=255"`
}
